ground = {
    ...
    'East Wing ground (EW4)':[('North Wing ground (NW1)',14), ('Way AAE',32), ('Way AAF',58),('',),('South Wing ground (SW2)',17)],
    ...
    'Lagoon':[('Way AAU',18), ('Lagoon',50), ('Lagoon',28)],
    'Lagoon':[('Way AAW',19), ('Lagoon entrance (LE3)',33), ('Lagoon',30)],
    'Lagoon':[('Lagoon entrance (LE2)',33), ('Lagoon',35), ('Way AAP',10)],
    'Lagoon entrance (LE1)':[('Way AAU',18), ('Lagoon',50), ('Lagoon',28)],
    'Lagoon entrance (LE2)':[('Way AAW',19), ('Lagoon entrance (LE3)',33), ('Lagoon',30)],
    'Lagoon entrance (LE3)':[('Lagoon entrance (LE2)',33), ('Lagoon',35), ('Way AAP',10)],
    'Ampitheather (AT)':[('Lagoon',43), ('Lagoon',19)],
